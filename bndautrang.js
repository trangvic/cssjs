...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='https://www.facebook.com/Piaggio-384835935026233/' target='_blank'><img src='http://www.topcom.com.vn/data/upload/Vespa_May-Promotion_Banner-999x537.jpg' width='500px'/><br/>Mua xe Vespa chính hãng</a>. hotline: 01255666688 - 0904 634 088.<h2><a class='close-linhnguyen-modal'>X</a></h2>");
